...
class UI:
    ...
    def get_number_of_vertices_ui(self):
        print("The number of vertices is: {}.".format(self._graphs[self._current_index_of_graph_list].number_of_vertices))
    ...
    def list_all_costs(self):
        for key in self._graphs[self._current_index_of_graph_list].parse_cost():
            line = "({}, {})".format(key[0], key[1]) + " :" + str(self._graphs[self._current_index_of_graph_list].dictionary_cost[key])
            print(line)
